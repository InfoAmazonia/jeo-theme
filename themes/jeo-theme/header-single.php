            ...
            '<div class="bottom-header-contain post-header">
					<div class="wrapper">
                        ...
                        <div class="page--share">
                            ...
                            <a class="messenger" href="http://www.facebook.com/dialog/send?app_id=693244528146031&link=<?= get_the_permalink() ?>&redirect_uri=<?= get_the_permalink() ?>" target="_blank"><i class="fab fa-facebook-messenger"></i></a>
