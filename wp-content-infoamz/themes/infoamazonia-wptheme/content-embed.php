...
if(isset($queryVars['map_id'])) {
	...
	$embed_title = get_the_title($queryVars['map_id']);
}
if(isset($queryVars['no_stories'])) {
...
if(isset($queryVars['p']) && $queryVars['p']) {
	$embed_title = get_the_title($queryVars['p']);
}
...
if(isset($queryVars['print'])) {
	...
	} elseif(isset($queryVars['p'])) {
		$coordinates = jeo_get_marker_coordinates($queryVars['p']);
