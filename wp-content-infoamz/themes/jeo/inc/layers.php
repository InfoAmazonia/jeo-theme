				...
				<tbody>
					...
					<tr class="subopt viz_type_viz">
						...
						<td>
							...
							<p class="description"><?php _e('CartoDB visualization URL.<br/>E.g.: https://infoamazonia.cartodb.com/api/v2/viz/621d23a0-5eaa-11e4-ab03-0e853d047bba/viz.json', 'jeo'); ?></p>
						</td>
					</tr>
